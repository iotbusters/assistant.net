...
namespace Assistant.Net.Messaging
{
    public static class CommandClientExtensions
    {
        ...
        public static Task<TResponse> Send<TResponse>(this ICommandClient client, ICommand<TResponse> command) =>
        ...
        /// </summary>
        public static Task Send(this ICommandClient client, ICommand command) => client.Send<None>(command);
    }
}